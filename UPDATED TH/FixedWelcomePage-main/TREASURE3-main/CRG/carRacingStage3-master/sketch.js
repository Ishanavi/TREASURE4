...
var track, car1_img, car2_img, car3_img, car4_img,treasure1,redFish;
...
function draw(){
  ...
  if(gameState === 1){
    clear();
    treasure1 = createSprite(200,300);
    redFish = createSprite(Math.round(random(30,100)),Math.round(random(50,100)));
